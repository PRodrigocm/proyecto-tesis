...
import { authenticateToken, requireAdmin, requireAdminOrAdministrativo, AuthenticatedRequest } from '../middleware/auth';
 ...
 */
router.get('/:id', authenticateToken, requireAdminOrAdministrativo, async (req: AuthenticatedRequest, res) => {
  try {
    const { id } = req.params;
