...
import { authenticateToken, requireAdminOrAdministrativo, AuthenticatedRequest } from '../middleware/auth';
 ...
 */
router.post('/', authenticateToken, requireAdminOrAdministrativo, async (req: AuthenticatedRequest, res) => {
  try {
 ...
 */
router.post('/inscribir', authenticateToken, requireAdminOrAdministrativo, async (req: AuthenticatedRequest, res) => {
  try {
...
router.get('/:id/estudiantes', authenticateToken, async (req, res) => {
  try {
    ...
    const response: ApiResponse = {
      success: true,
      data: {
        estudiantes: inscripciones.map((i: any) => ({
 ...
 */
router.put('/inscripciones/:id/estado', authenticateToken, requireAdminOrAdministrativo, async (req: AuthenticatedRequest, res) => {
  try {
    const { id } = req.params;
