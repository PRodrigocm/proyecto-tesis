...
import { authenticateToken, requireAdminOrAdministrativo, requireDocente } from '../middleware/auth';
 ...
 */
router.put('/:id/contactar', authenticateToken, requireAdminOrAdministrativo, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.put('/:id/entregar', authenticateToken, requireAdminOrAdministrativo, async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/:id/autorizar', authenticateToken, async (req, res) => {
  try {
    const { id } = req.params;
